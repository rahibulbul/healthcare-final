...
//             setIsUserCategoryValid(false);
//         } else {
//             const isUserCategoryTaken = await CheckUserCategory(userCategory);
...
//         setIsShow(e.target.checked); // e.target.checked is boolean (true/false)
//     };
...
//     //         const updates = {};
//     //         updates[`healthcare/userscategory/${updatedRow.id}`] = {
...
//             // Fetch the current data of the category from the database
//             const categoryRef = ref(database, `healthcare/userscategory/${updatedRow.id}`);
...
//             // Only update the usercategory and userCategoryInfo, keep the rest the same
//             const updatedData = {
//                 ...existingData, // Spread the existing data to retain fields like categoryid and showcategory
//                 usercategory: updatedRow.usercategory, // Updated category name
//                 userCategoryInfo: updatedRow.userCategoryInfo, // Updated category info
//                 lastUpdated: Date.now(), // Update the lastUpdated timestamp
//             };

//             // Update the database with the updated data
//             const updates = {};
//             updates[`healthcare/userscategory/${updatedRow.id}`] = updatedData;
...
//         try {
//             await remove(ref(database, `healthcare/userscategory/${id}`));
...
//                                 name="userCategory"
//                                 id="userCategory"
//                                 className="relative w-full border-2 border-slate-300 rounded-2xl py-2 px-5 font-semibold outline-none focus:border-slate-700 focus:shadow-ui-bold valid:border-slate-700 duration-500 peer"
//                                 required
//                                 value={userCategory}
...
//                             </span>
//                         </div>
//                         <div className=" mt-7 flex items-center gap-3 ml-5 text-sm text-slate-600 font-semibold cursor-pointer">
//                             <input type="checkbox" name="showcategory" id="showcategory" checked={isShow} onChange={handleCheckboxChange} />
//                             <label htmlFor="showcategory">Show this category on list?</label>
//                         </div>
//                     </div>
